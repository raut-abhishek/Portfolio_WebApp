...
const Navbar = () => {
  ...
  return (
    ...
    <nav className= {`fixed top-0 w-full z-50 transition duration-300 px-[7vw] lg:px-[20vw] ${
        isScrolled ? "bg-[#0500414] bg-opacity-50 backdrop-blur-md shadow-md" : "bg-transparent"
        }`}>
        <div className='text-white py-5 flex justify-between items-center'>

          {/* Logo */}
          <div className='lext-lg font-semibold cursor-pointer'>
          ...
          <div className='hidden md:flex space-x-4'>
            <a href="https://github.com/raut-abhishek" target='_blank' rel='noopener noreferrer' className='text-gray-300 hover:text-[#8245ec]'>
              <FaGithub size={24}/>
            </a>
            <a href="http://linkedin.com/in/abhishek-raut-736a3a21a" target='_blank' rel='noopener noreferrer' className='text-gray-300 hover:text-[#8245ec]'>
              <FaLinkedin size={24}/>
            </a>
          </div>
            {/* Mobile Menu icons */}
